...
public class PwdEditText extends AppCompatEditText {
    ...
    private void setAttrs(AttributeSet attrs) {
        ...
        if (t != null) {
            textLength = t.getInt(R.styleable.PwdEditText_pwd_textLength,6);
            ...
            Round = t.getDimensionPixelSize(R.styleable.PwdEditText_pwd_round, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,3,getResources().getDisplayMetrics()));
            Circle = t.getDimensionPixelSize(R.styleable.PwdEditText_pwd_circle, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,7,getResources().getDisplayMetrics()));
            textSize = t.getDimensionPixelSize(R.styleable.PwdEditText_pwd_textSize, (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,16,getResources().getDisplayMetrics()));
            checkedColor = t.getColor(R.styleable.PwdEditText_checkedColor,0xFF5284D0);
            defaultColor = t.getColor(R.styleable.PwdEditText_pwd_defaultColor,0xffd0d0d0);
            backColor = t.getColor(R.styleable.PwdEditText_pwd_backColor,0xfff1f1f1);
            textColor = t.getColor(R.styleable.PwdEditText_pwd_textColor,0xFF444444);
