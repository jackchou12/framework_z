 ...
 * @describe
 */
public class MyHeaderNoStatusViewSmall extends BaseHeader {
    ...
    public MyHeaderNoStatusViewSmall(Context context) {
        this(context, com.liaoinstan.springview.R.drawable.progress_small, com.liaoinstan.springview.R.drawable.arrow);
    }

    public MyHeaderNoStatusViewSmall(Context context, int rotationSrc, int arrowSrc) {
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.my_header_nostatusview_small, viewGroup, true);
        ...
        headerProgressbar = (ProgressBar) view.findViewById(R.id.layout_progressdialog_icon2);
