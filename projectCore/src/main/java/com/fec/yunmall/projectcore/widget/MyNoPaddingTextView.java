...
public class MyNoPaddingTextView extends android.support.v7.widget.AppCompatTextView {
     ...
     * @param attrs
     */
    public MyNoPaddingTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * @param defStyleAttr
     */
    public MyNoPaddingTextView(Context context, AttributeSet attrs, int defStyleAttr) {
