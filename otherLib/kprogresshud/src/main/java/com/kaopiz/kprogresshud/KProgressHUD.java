...
public class KProgressHUD {
   ...
   */
    ...
    /**
     * Set current progress1. Only have effect when use with a determinate style, or a custom
    ...
    /**
     * Specify whether this HUD closes itself if progress1 reaches max. Default is true.
     * @return Current HUD
     */
