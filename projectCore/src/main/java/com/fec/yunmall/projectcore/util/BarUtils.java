...
public class BarUtils {
    ...
    public static void translationStatusBarHeight(View view){
        if(view.getParent() instanceof RelativeLayout){
            RelativeLayout.LayoutParams lp2 = (RelativeLayout.LayoutParams)view.getLayoutParams();
            lp2.setMargins(lp2.leftMargin, lp2.topMargin+BarUtils.getStatusBarHeight(), lp2.rightMargin, lp2.bottomMargin);
