 ...
 * @describe 二维码查询数据
 */
public class QueryProductData implements Serializable {
    ...
    public List<GoodsTraceBean> getGoodsTrace() {
        return goodsTrace;
    }

    public void setGoodsTrace(List<GoodsTraceBean> goodsTrace) {
        this.goodsTrace = goodsTrace;
    }

    private List<GoodsTraceBean> goodsTrace;
    ...
    public static class GoodsTraceBean implements Serializable{
        /**
